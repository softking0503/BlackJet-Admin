...
let generateUpgradeEliteInvoicePdf = async (transaction, user) => {
  try {
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td
                                          ...
                                          "
                                        >
                                          PRORATED DIFFERENCE (upgraded membership):
                                          <br />
                                          ${transaction.name} Membership – ${transaction.currdate} to ${transaction.renewalDateInfo}
                                        </td>
                                        <td
                                          style="
                                            text-align: right;
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            <p
                                              ...
                                              "
                                            >
                                              We've processed your payment using your
                                              saved payment method in the app.
                                            </p>
                                          </div>
                                        </div>
                                      </td>
...
module.exports = {
  generateUpgradeEliteInvoicePdf
}
