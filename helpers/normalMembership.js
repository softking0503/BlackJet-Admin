...
let generateNormalMembershipInvoicePdf = async (transaction, user) => {
  try {
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td
                                          ...
                                          "
                                        >
                                        ${transaction.name} Membership – ${transaction.purchaseDate} to ${transaction.renewal_date} 
                                        </td>
                                        <td
                                          style="
                                            text-align: right;
                                      ...
                                      <tr>
                                        <td
                                          ...
                                          "
                                        >
                                        DISCOUNT: ${transaction.name} Membership – ${transaction.purchaseDate} to ${transaction.renewal_date} 
                                        </td>
                                        <td
                                          style="
                                            text-align: right;
    ...
    // let filename = 'invoicepdf/' + date.getTime() + '.pdf';//pdf filename
    //S3 upload 
    const s3 = new AWS.S3();
    const params = {
      Bucket: BUCKET_NAME,
...
module.exports = {
  generateNormalMembershipInvoicePdf
}
