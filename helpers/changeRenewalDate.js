...
let generateChangeRenewalDateInvoicePdf = async (transaction, user) => {
  try {
                                            ...
                                            <tr>
                                              ...
                                              >
                                                <div
                                                  ...
                                                  "
                                                >
                                                  BLACK JET MOBILITY PTY LTD Suite 302,
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td
                                          ...
                                          "
                                        >
                                        PRORATED PERIOD (changed renewal date):
                                        ${transaction.name} Membership – ${transaction.renewalDateInfo} to ${transaction.new_renewable_date}
                                      ...
                                      <tr>
                                        <td
                                          ...
                                          "
                                        >
                                        DISCOUNT: ${transaction.name} Membership – ${transaction.renewalDateInfo} to ${transaction.new_renewable_date}
...
module.exports = {
  generateChangeRenewalDateInvoicePdf
}
